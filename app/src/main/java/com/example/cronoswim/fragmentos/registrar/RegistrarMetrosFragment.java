...
public class RegistrarMetrosFragment extends Fragment {
    ...
    private void registrar() {
        ...
        if (campoNombres.getText().toString().trim().equalsIgnoreCase("")){
            ...
            values.put(Tablas_BD.CAMPO_METROS_NOMBRE,campoNombres.getText().toString());


            Long idResultante=db.insert(Tablas_BD.TABLA_METROS,Tablas_BD.CAMPO_METROS_ID,values);
